    ...
    try {
      return await this.prisma.propiedad.create({
        data: {
          ...
          latitud: dto.latitud != null ? dto.latitud : null,
          longitud: dto.longitud != null ? dto.longitud : null,
    ...
    try {
      return await this.prisma.propiedad.update({
        ...
        data: {
          ...
          ...(dto.anioConstruccion !== undefined && { anioConstruccion: dto.anioConstruccion }),
